			...
			<div class="swiper-container swiper-slider">
				<div class="jumbotron-mod-1 text-center">
					<div>
						...
						<p>The concept behind the creation of most multipurpose themes is to produce a single website template that would suit any type of company</p><div class='btn-group-variant'> <a class='btn btn-success btn-sm' href='#'>BUY a theme</a> <a class='btn btn-white btn-sm' href='#'>view featured</a></div>
					</div>
				</div>
		...
		<main class="page-content">
			<section class="section">
				<div class="container">
					...
					<hr>
					<p class="h5 fw-l">We create user interfaces and modern websites. We will help you build strong online<br class="d-none d-lg-inline">business by creating a professional website which best suits your needs.</p>
					<div class="row row-60 clearleft-custom offset-custom-2">
						...
						<div class="col-12 col-md-6 col-xl-3">
							<div class="thumbnail thumbnail-mod-1"><span class="icon icon-success icon-lg icon-mod-1 fa-pencil-square-o"></span>
								<div class="caption">
						...
						<div class="col-12 col-md-6 col-xl-3">
							<div class="thumbnail thumbnail-mod-1"><span class="icon icon-success icon-lg icon-mod-1 fa-comments-o"></span>
								<div class="caption">
			...
			<section class="section section-inset-1 bg-accent">
				<div class="container">
					...
					<div class="row row-45">
						<div class="col-12 col-md-12 col-lg-6 text-center text-lg-left"><img src="images/index-1.jpg" alt=""></div>
						<div class="col-12 col-md-12 col-lg-6 text-lg-left well1">
							...
							<p>You probably won't have a better opportunity to make sure of our competence, as well as friendliness towards our customers.</p>
					...
					</div><a class="btn btn-white btn-sm btn-min-width" href="#">learn more</a>
				</div>
			</section>
			...
			<section class="section section-inset-1 bg-light">
				<div class="container">
					...
					<div class="row">
						<!-- Owl Carousel-->
						<div class="owl-carousel owl-carousel-mod-1" data-items="1" data-md-items="2" data-xl-items="3" data-loop="true" data-margin="15" data-dots="true" data-autoplay="true" data-dots-each="1" data-xs-stage-padding="15">
							<div class="owl-item"><img src="images/partner-1.png" alt=""><img src="images/partner-2.png" alt=""></div>
							<div class="owl-item"><img src="images/partner-3.png" alt=""><img src="images/partner-4.png" alt=""></div>
							<div class="owl-item"><img src="images/partner-5.png" alt=""><img src="images/partner-6.png" alt=""></div>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row row-45 text-md-left">
							...
							<div class="blog-post thumbnail-1 thumbnail-mod-2"><img src="images/index-8.jpg" alt="">
								<div class="caption">
									<div class="blog-post-title">
										<h4 class="text-success-custom text-transform-none"><a href="#">Top 10 Website Mistakes<br>To Avoid</a></h4>
									</div>
									<div class="blog-post-time">
										<time datetime="2015-12-26">December 26, 2015</time>
									</div>
									<div class="blog-post-body">
										<p>Many websites have mistakes that can dramatically impact on their effectiveness. At best your website has 6 seconds to capture the interest of the viewer.</p><a class="badge fa-comment text-success-custom" href="#">43</a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<div class="blog-post thumbnail-1 thumbnail-mod-2"><img src="images/index-9.jpg" alt="">
								<div class="caption">
									<div class="blog-post-title">
										<h4 class="text-success-custom text-transform-none"><a href="#">Social Media Marketers</a></h4>
									</div>
									<div class="blog-post-time">
										<time datetime="2015-12-26">December 26, 2015</time>
									</div>
									<div class="blog-post-body">
										<p>Online social networks have become the new way in which people connect socially for both business and personal use.</p><a class="badge fa-comment text-success-custom" href="#">17</a>
									</div>
								</div>
							</div>
						</div>
						<div class="col-12 col-md-12 col-lg-4">
							<div class="blog-post thumbnail-1 thumbnail-mod-2"><img src="images/index-10.jpg" alt="">
								<div class="caption">
									<div class="blog-post-title">
										<h4 class="text-success-custom text-transform-none"><a href="#">Coworking Project</a></h4>
									</div>
									<div class="blog-post-time">
										<time datetime="2015-12-26">December 26, 2015</time>
									</div>
									<div class="blog-post-body">
										<p>Colour choice in logo design is critical. The colour you decide on to represent your business can greatly affect peoples perception of your business.</p><a class="badge fa-comment text-success-custom" href="#">6</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row justify-content-center offset-custom-3">
						<div class="col-12 col-lg-9 col-xl-6 col-lg-offset-2 col-xl offset-custom-3">
							<p class="fw-l h5 text-transform-none">Enter your email address to receive all news, updates on new arrivals, special offers and other discount information.</p>
							<!-- RD Mailform-->
							<form class="rd-mailform subscribe-form" data-result-class="rd-mailform-validate" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
								<div class="form-wrap">
